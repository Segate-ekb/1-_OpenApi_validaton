...
Процедура ИсполняемыеСценарии() Экспорт
    ...
    ЮТТесты
		...
		.ДобавитьТестовыйНабор("СмешанныеТипы1С")
			.ДобавитьТест("Дата1СсОграничениемСтроки")
			.ДобавитьТест("Идентификатор1СсОграничениемСтроки")
			.ДобавитьТест("МножествоДат1С")
			.ДобавитьТест("МножествоИдентификаторов1С")
КонецПроцедуры
...
Процедура Дата1СсОграничениемСтроки() Экспорт
	
	ОбъектПроверки = Новый Структура("date", '2024-12-31');
	
	ИмяСхемы = "mixed_types_1C";
	МассивОшибок = Валидировать(ОбъектПроверки, ИмяСхемы).Ошибки;
...
Процедура Идентификатор1СсОграничениемСтроки() Экспорт
	
	ОбъектПроверки = Новый Структура("uuid", Новый УникальныйИдентификатор());
...
Процедура МножествоДат1С() Экспорт
	
	ОбъектПроверки = Новый Структура("set_of_dates",
		ЮТКоллекции.ЗначениеВМассиве("2024-12-31", '2024-12-31'));
...
Процедура МножествоИдентификаторов1С() Экспорт
	
	Идентификатор = Новый УникальныйИдентификатор();
	ОбъектПроверки = Новый Структура("set_of_uuids",
		ЮТКоллекции.ЗначениеВМассиве(Идентификатор, Строка(Идентификатор), ВРег(Идентификатор)));
